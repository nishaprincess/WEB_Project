 ...
 <!-- ************* Navbar Start *************-->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
	  ...
	  <form action="Content_update/content_update_loc.php" method="get">
 ...
 while($row = $result->fetch_assoc()) 
        ...
        if($count>=1)
		  ...
		  while($row = $result->fetch_assoc()) 
		  {
		     ...
		     echo'<form id="" action="location_update.php">';
			...
			{
			 echo'<form id="" action="location_insert.php">
