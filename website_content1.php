	 ...
	 if(mysql_num_rows($data)>0)
	   {
				 ...
				 # code...
				 echo '<p style="text-align: center;font-weight: bold;font-size: 28px;margin-top:40px;text-shadow:3px 3px 6px #D29004;">'.$row["header"].'</p>';

         echo ' <img src="images/border.jpg" width="845px;" alt="">';

				 echo '<p style="color: #000;text-align: justify;text-justify: inter-word;font-size: 16px;margin-top:20px;">'.$row["description"].'</p>
...
if(isset($_POST['activity_show_detail']))
{
     $id=$_POST['iid'];
   ...
   if(mysql_num_rows($data)>0)
     {
         ...
         # code...
         echo '<p style="color: #000;text-align: center;font-size: 18px;margin-top:10px;">'.$row["aname"].'</p>';
         echo '<p style="color: #000;text-align: justify;text-justify: inter-word;font-size: 16px;margin-top:20px;">'.$row["adesc"].'</p>
...
if(isset($_POST['activity_video_detail']))
{
   ...
   if(mysql_num_rows($data)>0)
     {
      ...
      {
        echo '<p style="color: #000;text-align: center;font-size: 40px;">No Video Added</p>';
      }
}
...
if(isset($_POST['activity_upcome_detail']))
{
     $id=$_POST['iid'];

     $q="SELECT * FROM up_events where id=$id";
   ...
   if(mysql_num_rows($data)>0)
     {
         ...
         # code...
         echo '<p style="color: #000;text-align: center;font-size: 18px;margin-top:20px;">'.$row["ename"].'</p>';
         echo '<p style="color: #000;text-align: justify;text-justify: inter-word;font-size: 16px;margin-top:14px;">'.$row["edesc"].'</p>';

        

         echo '<a href="'.$row['link'].'" target="_blank" style="color:#9b0d15;float:left;text-justify: inter-word;font-size: 14px;margin-top:8px;margin-left:0px;">Click Here</a>
...
if(isset($_POST['register_contact']))
{
  ...
  $s="'".$e."'";
        ...
        $query2="INSERT INTO contact_table(name,email,body) VALUES('$f','$e','$l')";
      ...
      //  echo $query2; 
        ...
        {
          echo '<div class="alert alert-success" role="alert"><b>Message is sent successfully</b></div>';
        }
        else
        {
           echo '<div class="alert alert-success" role="alert"><b>Could not sent message</b></div>';
        }
