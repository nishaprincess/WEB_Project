...
.main_container2 {
background-image: url("images/bacfea040218b77b4c81e5b469807a4b.jpg");}
.main_container2{
 ...
 <!-- ************* Navbar Start *************-->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
	  ...
	  <form action="Content_update/content_update_activities.php" method="get">
...
<button type="submit" class="btn-primary">UPDATE</button>
 ...
 <?php
		  ...
		  while($row = $result->fetch_assoc()) 
		  {
			 ...
			 <form id="" action="activities_insert.php" >
	         ...
	         <div class="form-group">
				  ...
				  <div class="form-group">
				    ...
				    <textarea class="form-control" rows="6" name="adesc" placeholder="" required></textarea>
	          	       ...
	          	       echo '
						     ...
						     <div class="col-xs-4">
						              ...
						              <div class="main_container2" style="align:center;">
						                  ...
						                  <a href="activities_details.php?nid='.$row["id"].'"><h3 id="notice_head" style=" color: white ;text-align:center;padding-top: 80px;margin-bottom:10px;"><strong>'.$row["aname"].'</strong></h3></a>
