 ...
 <!-- ************* Navbar Start *************-->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
	  ...
	  <form action="Content_update/content_update_email&phone.php" method="get">
 ...
 while($row = $result->fetch_assoc()) 
        ...
        if($count>=1)
		  ...
		  while($row = $result->fetch_assoc()) 
		  {
		     ...
		     echo'<form id="" action="email_phone_update.php">';
			...
			{
			 echo'<form id="" action="email_phone_insert.php">
	         ...
	         <div class="form-group">
				  ...
				  <div class="form-group">
				    <label for="">PHONE NO:</label>
				    <input type="number" name="phone"  class="form-control" max="99999999999"  required>
