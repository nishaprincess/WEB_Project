 ...
 <!-- ************* Navbar Start *************-->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
	  ...
	  <form action="Content_update/content_update_event_linkt.php" method="get">
 ...
 while($row = $result->fetch_assoc()) 
        ...
        if($count>=1)
		  ...
		  while($row = $result->fetch_assoc()) 
		  {
		     ...
		     echo'<form id="" action="event_link_update.php">';
			
	         echo'<div class="form-group">
				    <label for="">Event Name:</label>
				    <input type="text" class="form-control" name="ename" id="ename" value="'.$row['ename'].'" required>
				  </div>

				  <div class="form-group">
				    <label for="">Event link:</label>
				    <input type="text" class="form-control" name="link" id="link" value="'.$row['link'].'" required>
			...
			{
			 echo'<form id="" action="event_link_insert.php">
...
var h = document.getElementById("ename").value;
