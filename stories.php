 ...
 <!-- ************* Navbar Start *************-->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
	  ...
	  <form action="Content_update/content_update_stories.php" method="get">
 ...
 while($row = $result->fetch_assoc()) 
        ...
        if($count>=1)
		  ...
		  while($row = $result->fetch_assoc()) 
		  {
	         ...
	         echo'<form id="" name="video" action="stories_update.php"enctype="multipart/form-data" method="post">
			 <input name="MAX_FILE_SIZE" value="100000000000000"  type="hidden"/>
	         <div class="form-group">
				    <label for="">Header</label>
				    <input type="text" class="form-control" name="header" id="head" value="'.$row['header'].'" required>
				  </div>
				  <div class="form-group">
				  ...
				  <div class="form-group">
                    ...
                    <input type="file" class="form-control" name="uploadvideo" id="file" value=""/> 	
				  </div>
				  
				  <div align="center">

			         <input type="submit" class="btn btn-primary btn-lg" name="upload" id="upload" value="UPDATE">
			...
			{
			 echo'<form id="" name="video" action="stories_insert.php"enctype="multipart/form-data" method="post">
			 <input name="MAX_FILE_SIZE" value="100000000000000"  type="hidden"/>
	         <div class="form-group">
				  ...
				  <div class="form-group">
                    ...
                    <input type="file" class="form-control"name="uploadvideo" id="file" required /> 				     
				  </div>
