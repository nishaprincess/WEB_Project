	  	...
	  	<div class="header">
	  		...
	  		<div class="header-left-side">
		  		...
		  		<ul class="nav">
		  			...
		  			<li class="left_"><a class="left_a " href="#" id="home_show_">Home</a></li>
...
?>
 ...
 <!-- Body part starts --> 
    ...
    <!-- About part --> 
	  ...
	  <div class="col-md-12" style="background-color:#EDEDED;padding: 0px;" id="home_show_detail">
		   ...
		   <div class="col-md-4" id="breaking_news" style="">
              ...
              <p style="text-align: center;font-size: 28px;margin-top:40px;text-shadow:3px 3px 6px #D29004;font-weight: bold;">Breaking News</p>


              <img src="images/border2.jpg" width="407px" alt="">
