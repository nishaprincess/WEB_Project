...
.main_container2 {
background-image: url("images/technology-background-with-gradient-colors_23-2147837710.jpg");}
.main_container2{
 ...
 <!-- ************* Navbar Start *************-->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
	  ...
	  <form action="Content_update/content_update_up_event.php" method="get">
...
<button type="submit" class="btn-primary">UPDATE</button>
 ...
 <div style="margin-top:70px;background-color: #337AB7;text-align:center;" class="alert alert-success" role="alert"><b style="color:#fff;"><?php
		  ...
		  while($row = $result->fetch_assoc()) 
		  {
			 ...
			 <form id="" action="up_event_insert.php" method="post">
	         ...
	         <div class="form-group">
				  ...
				  <div class="form-group">
				    ...
				    <textarea class="form-control" rows="6" name="edesc" placeholder="" required></textarea>
	          	       ...
	          	       echo '
						     ...
						     <div class="col-xs-4">
						              ...
						              <div class="main_container2" style="align:center;">
						                 ...
						                 <a href="up_event_details.php?nid='.$row["id"].'" align:center evt_notice_id="'.$row["id"].'" ><h3 id="notice_head" style=" color:white; text-align:center;padding-top: 80px;;margin-bottom:10px;"><strong>'.$row["ename"].'</strong></h3></a>
