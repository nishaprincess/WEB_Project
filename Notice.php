 ...
 <!-- ************* Navbar Start *************-->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
	  ...
	  <form action="Content_update/content_update_Notice.php" method="get">
...
<button type="submit" class="btn-primary">UPDATE</button>
 ...
 <div style="margin-top:70px;background-color: #337AB7;text-align:center;" class="alert alert-success" role="alert"><b style="color:#fff;"><?php
		  ...
		  while($row = $result->fetch_assoc()) 
		  {
			 ...
			 <form id="" action="notice_insert.php">
			
	         <div class="form-group">
				    <label for="">Notice Header</label>
				    <input type="text" class="form-control" name="notice_header" required>
				  </div>

				  <div class="form-group">
				    <label for="">Notice detail</label>
				    <textarea class="form-control" rows="6" name="notice_detail" placeholder=""required></textarea>
	          	       ...
	          	       echo '
						     ...
						     <div class="col-xs-4">
						              ...
						              <div class="main_container2" style="align:center;">
						                  ...
						                  <h4 id="notice_head" style=" text-align:center;padding: 20px;margin-bottom:10px;"><strong>'.$row["head"].'</strong></h4>
						                  ...
						                  <div id=""style="margin-left:10px;" >
							                   ...
							                   <a href="notice_delails.php?nid='.$row["id"].'" align:center class="btn btn-small btn-tertiary show_total_notice" style="color: #fff;background: #533185; border: .0625rem solid #9177b9;" evt_notice_id="'.$row["id"].'" >Total Info</a>
                                                <p id="notice_body" style=" text-align:center;">'.readMoreFunction($row["body"]).'<b>.....</b></p>
