 ...
 <!-- ************* Navbar Start *************-->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
	  ...
	  <form action="Content_update/content_update_breaking.php" method="get">
...
<button type="submit" class="btn-primary">UPDATE</button>
 ...
 <?php
		  ...
		  while($row = $result->fetch_assoc()) 
		  {
			 ...
			 <form id="" action="breaking_insert.php">
	         ...
	         <div class="form-group">
				  ...
				  <div class="form-group">
				    ...
				    <textarea required class="form-control" rows="6" name="bdesc" placeholder=""></textarea>
				     
				  </div>
				  <div class="form-group">
				    <label for="">ADD LINKS IF ANY:</label>
				  </div>
				  <div class="form-group">
						     ...
						     <div class="col-xs-4">
						              ...
						              <div class="main_container2" style="align:center;">
						                  ...
						                  <div id=""style="margin-left:10px;" >
							                   ...
							                   <a href="breaking_details.php?nid='.$row["id"].'" align:center class="btn btn-small btn-tertiary show_total_notice" style="color: #fff;background: #533185; border: .0625rem solid #9177b9;" evt_notice_id="'.$row["id"].'" >Total Info</a>
                                                <p id="notice_body" style=" text-align:center;">'.readMoreFunction($row["bdesc"]).'<b>.....</b></p>
