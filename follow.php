 ...
 <!-- ************* Navbar Start *************-->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
	  ...
	  <form action="Content_update/content_update_follow.php" method="get">
 ...
 while($row = $result->fetch_assoc()) 
        ...
        if($count>=1)
		  ...
		  while($row = $result->fetch_assoc()) 
		  {
		     ...
		     echo'<form id="" action="follow_update.php">';
			
	         echo'<div class="form-group">
				    <label for="">Facebook link:</label>
				    <input type="text" class="form-control" name="fblink" value="'.$row['fblink'].'">
				  </div>
				  <div class="form-group">
				    <label for="">Gmail link:</label>
				    <input type="text" class="form-control" name="glink" value="'.$row['glink'].'">
				  </div>
				  <div class="form-group">
				    <label for="">Twitter link:</label>
				    <input type="text" class="form-control" name="tlink" value="'.$row['tlink'].'">
				  </div>
				  <div class="form-group">
				    <label for="">Youtube link:</label>
				    <input type="text" class="form-control" name="ylink" value="'.$row['ylink'].'">
				  </div>
			...
			{
			 echo'<form id="" action="follow_insert.php">
