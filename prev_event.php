...
.main_container2 {
background-image: url("images/vector-colorful-background.jpg");}
.main_container2{
 ...
 <!-- ************* Navbar Start *************-->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
	  ...
	  <form action="Content_update/content_update_prev_event.php" method="get">
...
<button type="submit" class="btn-primary">UPDATE</button>
 ...
 <div style="margin-top:70px;background-color: #337AB7;text-align:center;" class="alert alert-success" role="alert"><b style="color:#fff;"><?php
		  ...
		  while($row = $result->fetch_assoc()) 
		  {
			 ...
			 <form id="" action="prev_event_insert.php" method="post">
	         ...
	         <div class="form-group">
				  ...
				  <div class="form-group">
				    <label for="">Link:</label>
                       <input type="text" class="form-control" name="link"  placeholder="Enter event link if any" required>				     
				  </div>
	          	       ...
	          	       echo '
						     ...
						     <div class="col-xs-4">
						              ...
						              <div class="main_container2" style="align:center;">
						                 ...
						                 <a href="prev_event_details.php?nid='.$row["id"].'" align:center evt_notice_id="'.$row["id"].'" ><h3 id="notice_head" style=" color:white; text-align:center;padding-top: 80px;;margin-bottom:10px;"><strong>'.$row["ename"].'</strong></h3></a>
